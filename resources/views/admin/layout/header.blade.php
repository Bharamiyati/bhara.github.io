                        ...
                        <div class="dropdown for-message">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <span class="message media-body">
                                    <span class="name float-left">Yusuf Farhan</span>
                                ...
                                <span class="message media-body">
                                    <span class="name float-left">Refki Berga</span>
                                ...
                                <span class="message media-body">
                                    <span class="name float-left">Firman Fauzy</span>
                                ...
                                <span class="message media-body">
                                    <span class="name float-left">Noval Dinda</span>
                                    <span class="time float-right">15 menit yang lalu</span>
                                        <p>Lorem ipsum dolor sit amet, consectetur</p>
                                </span>
                            </a>
                            </div>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{asset('public/images/raiku.png')}}" alt="User Avatar">
                        </a>
