                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <a href="{{route('antrian.create')}}" class='btn btn-primary pull-right'>Tambah</a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$row->nama_antrian}}</td>
                                            <td>{{$row->alamat_pengantri}}</td>
                                            <td><a href="{{route('antrian.edit',$row->id)}}" class='btn btn-primary'>Edit</a></td>
                                            <td>
