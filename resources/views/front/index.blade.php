...
<head>
    ...
    <title>Website Gue Nich</title>

    <!-- favicon -->
    <link href="{{asset('public/front/assets/img/favicon.png')}}" rel=icon>

    <!-- web-fonts -->
    <link href='https://fonts.googleapis.com/css?family=Roboto:101,300,400,700,500' rel='stylesheet' type='text/css'>
    ...
    <!-- HTML6 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!--[if lt IE 10]>
    <script src="https://oss.maxcdn.com/html6shiv/3.7.2/html5shiv.min.js"></script>
    <script src="https://oss.maxcdn.com/respond/2.4.2/respond.min.js"></script>
    <![endif]-->
</head>
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
                                data-target="#navbar-collapse0"><span class="sr-only">Toggle navigation</span> <span
